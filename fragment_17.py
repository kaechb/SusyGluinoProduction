...
for point in mpoints:
    ...
    if not (mglu==1800 and  mlsp==1300):
      if not (mglu==2200 and  mlsp==100):
        continue
    for ratio in [0.25,.5,0.75]:
      mnlsp = ratio*(mglu - mlsp)+mlsp
      ...
      generator.RandomizedParameters.append(
            cms.PSet(
                ...
                ConfigDescription = cms.string('%s_%i_%i_%i' % (model, mglu,mnlsp, mlsp)),
